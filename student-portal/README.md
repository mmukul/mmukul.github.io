...
The dashboard does not hard-code a student name. After authentication, it reads `profiles.full_name` for the currently logged-in user and displays that name in the welcome message.
